...
public class ToastUtil {
    ...
    public ToastUtil shortDuration(CharSequence message) {
        if (mToast == null) {
            mToast = Toast.makeText(MyApplication.application, message, Toast.LENGTH_SHORT);
        } else {
    ...
    public ToastUtil longDuration(CharSequence message) {
        if (mToast == null) {
            mToast = Toast.makeText(MyApplication.application, message, Toast.LENGTH_LONG);
        } else {
            mToast.setText(message);
    ...
    public ToastUtil(View view) {
        mToast = new Toast(MyApplication.application);
        mToast.setView(view);
        mToast.setDuration(Toast.LENGTH_SHORT);
        mToast.show();
    }
