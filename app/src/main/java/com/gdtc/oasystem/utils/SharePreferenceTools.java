...
/**
 * @ClassName: SharePreferenceUtils * @Description: SharePreference工具类 * @Author：lxs *
 */
...
public class SharePreferenceTools {
    ...
    public SharePreferenceTools(Context context) {
        this(context, Config.PREFERENCE_DEFAULT_NAME, Context.MODE_PRIVATE);
    }
    ...
    public long getLong(String key, long defaultValue) {
        ...
        if (!TextUtils.isEmpty(key)) value = sharedPreferences.getLong(key, defaultValue);
    	return value;
}
    ...
    public float getFloat(String key, float defaultValue) {
        ...
        if (!TextUtils.isEmpty(key)) value = sharedPreferences.getFloat(key, defaultValue);
    	return value;}

public void putStringSet(String key,Set<String> value){if(!TextUtils.isEmpty(key)){editor.putStringSet(key,value);editor.commit();}}

public Set<String> getStringSet(String key){Set<String> set=null;if(!TextUtils.isEmpty(key)){set=sharedPreferences.getStringSet(key,null);}return set;}
