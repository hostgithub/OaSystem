...
/**
 * Created by wangjiawei on 2018-1-8.
 */

public class ThankJellyScrollView extends ScrollView {
    ...
    public ThankJellyScrollView(Context context) {
        super(context);
    }

    public ThankJellyScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ThankJellyScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
