...
public class ZwsqSubmit2Activity extends BaseActivity{
    ...
    @BindView(R.id.edt_join_work_time)
    EditText edt_join_work_time;//参加工作时间
    @BindView(R.id.edt_work_years)
    EditText edt_work_years;//工作年限

    @BindView(R.id.edt_normal_relax_year_days)
    EditText edt_normal_relax_year_days;//应休年休假天数
    @BindView(R.id.edt_last_year_sick_days)
    EditText edt_last_year_sick_days;//去年请病假天数
    @BindView(R.id.edt_last_year_things_days)
    EditText edt_last_year_things_days;//去年请事假天数
    @BindView(R.id.edt_last_year_unrelax_days)
    EditText edt_last_year_unrelax_days;//应休年休假未休天数
    ...
    protected int getLayoutId() {
        return R.layout.activity_zwsq_submit2;
    }
...
//                popupWindow.showAsDropDown(titleBar, 0, 0,Gravity.CENTER);
            ...
            case R.id.stop:
                if(!start.getText().toString().trim().equals("")){
                    ...
                    Toast.makeText(ZwsqSubmit2Activity.this,"请选择开始时间",Toast.LENGTH_SHORT).show();
                }
                break;
...
//                popupWindow.showAsDropDown(titleBar, 0, 0,Gravity.CENTER);
            ...
            case R.id.btn_submit://提交
                if(dayCount==0.0){
                    AlertDialog.Builder builder=new AlertDialog.Builder(ZwsqSubmit2Activity.this);
                ...
                Toast.makeText(ZwsqSubmit2Activity.this,"提交",Toast.LENGTH_SHORT).show();
                break;
    ...
    protected void showDatePickDlg(final TextView textView) {
        ...
        TimePickerDialog timePickerDialog=new TimePickerDialog(ZwsqSubmit2Activity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
...
//                    stop.setText(year + "-" + monthOfYear + "-" + dayOfMonth);
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(ZwsqSubmit2Activity.this, new DatePickerDialog.OnDateSetListener() {
